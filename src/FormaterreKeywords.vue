...
<template>
    <span>
        ...
        <template v-if="listed.length > 0">
            <h3>{{t.main_classification[lang]}}</h3>
            <div class="voclist">
         ...
         <h3>{{t.search_in_thesauri[lang]}}</h3>
        ...
        <h4>{{t.recommended_thesauri[lang]}}</h4>
        ...
        <h4>{{t.other_thesauri[lang])}}<span @click="showOthers=!showOthers" class="mini-button">{{ showOthers ? '-' : '+' }}</span></h4>
...
export default {
    ...
    data () {
        return {
            ...
            showOthers: false,
            t: {
                main_classification:{ fr: 'Principale classification', en: 'Main classification'},
                other_thesauri: {fr: 'Autres thésaurus', en: 'Other thesauri'},
                search_in_thesauri: {fr: 'Rechercher dans les thésaurus', en: 'Search in thesauri'},
                recommended_thesauri: {fr: 'Thésaurus recommandés', en: 'Recommended thesauri'}
            },
            types: {
                discipline: {
